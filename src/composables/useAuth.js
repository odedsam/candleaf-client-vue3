...
export function useAuth() {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!token)
                        return [2 /*return*/];
                    return [4 /*yield*/, fetch("http://localhost:5001/api/user/profile", {
    ...
    var login = function (email, password) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("http://localhost:5001/api/auth/login", {
                        method: "POST",
    ...
    return { user: user, isAuthenticated: isAuthenticated, fetchUser: fetchUser, login: login, logout: logout };
}
