...
<template>
  <section
    class="flex flex-col lg:flex-row items-center justify-between bg-gray-100 p-12 rounded-lg"
  >
    <!-- text content -->
    <div class="lg:w-1/2 space-y-4">
      ...
      <RouterLink to="/products">
        <button
          class="mt-6 px-6 py-3 cursor-pointer bg-[#56B280] text-white font-semibold rounded-lg shadow-md hover:bg-[#88edb6] transition"
        >
          Learn more
        </button>
      </RouterLink>
