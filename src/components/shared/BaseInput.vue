...
<template>
  <div :class="['relative', size === 'half' ? 'w-1/2' : 'w-full']">
    <input
      ...
      class="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#56b280]/50 focus:border-[#56b280] outline-none transition ease-in-out duration-200"
    />
