  ...
  <div class="justify-center items-center flex flex-col gap-2">
    <button
      ...
      <svg class="w-6 h-6" viewBox="0 0 48 48">
        ...
        <path fill="#EA4335" d="M24 46c5.73 0 10.47-1.85 13.96-5.03l-7.26-5.62c-2.03 1.36-4.62 2.17-7.47 2.17-5.98 0-11.06-3.87-12.89-9.2l-7.32 5.67C6.91 40.62 14.72 46 24 46z" />
