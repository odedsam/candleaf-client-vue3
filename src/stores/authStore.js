...
export var useAuthStore = defineStore('auth', function () {
    ...
    var error = ref(null);
    var isAuthenticated = computed(function () { return !!user.value; });
    var handleGoogleSignIn = function () { return __awaiter(void 0, void 0, void 0, function () {
        var accessToken, userData, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    accessToken = _a.sent();
                    return [4 /*yield*/, verifyGoogleToken(accessToken)];
                case 3:
                    userData = _a.sent();
                    if (userData) {
                        user.value = userData;
                ...
                case 4:
                    err_1 = _a.sent();
                    console.error('Google login failed:', err_1);
                    error.value = (err_1 === null || err_1 === void 0 ? void 0 : err_1.message) || 'Login failed';
                    return [3 /*break*/, 6];
                case 5:
